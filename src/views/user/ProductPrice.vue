                ...
                >
                  <table class="table border mt-3 mb-2">
                    ...
                    >
                      ...
                      <div>
                        <span class="card-title text-danger fw-bolder" style="font-size: 16px;"
                          >{{
                            productPrice.price.toLocaleString("vi-VN")
                          }}
                          đ</span
            ...
            <div class="px-0 border rounded-2 shadow-0">
              <div class="card">
                <div class="card-body">
                  ...
                  >
                    <p class="fw-semibold">
                      Giá iPhone 16 series VN/A giảm hàng loạt chỉ sau hơn 1
                      tháng bán ra tại Việt Nam
                    </p>
                    <div>
                      Điện thoại iPhone 16 series chính thức bán ra tại thị
                      trường Việt Nam từ ngày 27/12/2024, và cho tới hiện tại là
                      chỉ hơn 1 tháng được bán ra trên thị trường nhưng tất cả
                      các phiên bản iPhone 16 đã giảm giá hàng loạt.
                    </div>
                    <table class="table border mt-3 mb-2">
                      <tr>
